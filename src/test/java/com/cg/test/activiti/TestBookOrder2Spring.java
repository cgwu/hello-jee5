...
public class TestBookOrder2Spring {
	private static final Logger log = LoggerFactory
			.getLogger(TestBookOrder2Spring.class);
	...
	public void simpleSpringTest() {
		...
		variableMap.put("isbn", 1234567L);
		runtimeService.startProcessInstanceByKey("bookorder2", variableMap);
